...
const Carrinho = () => {
  ...
  return (
    ...
    <h2 className='text-emerald-600 text-3xl pb-10 '>Total: R$ {calcularTotal()}</h2>
    </div>
    <div className='flex'>
    <Link to='/produtos'><button className='m-2 rounded bg-cyan-950 px-4 py-2 text-white'>Continuar Comprando</button></Link>
    <Link to='/pedido'><button className='m-2 rounded bg-cyan-950 px-4 py-2 text-white'>Finalizar Pedido</button></Link>
    </div>
  </div>
  </div>
);
